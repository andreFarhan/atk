	...
	<div class="container mt-5 mb-5 text-white">
		<div class="d-flex flex-row-reverse">
			<div class="col-md-6 rounded" style="background-color: #9c0000;">
				<form method="POST">
					<h3 class="font-weight-bold mt-3"><img src="img/logo-ATK.png" alt="Responsive image" width="50px"> Selamat Datang di</h3>
					<h3>Pengelolaan ATK Kelurahan Cipayung</h3>
					<div class="form-group">
						<label class="font-weight-bold" for="username">MASUKKAN USERNAME</label>
					...
					<div class="form-group">
						...
						<a href="registrasi.php" class="btn btn-outline-primary bg-light">REGISTRASI <i class="fa fa-pencil"></i></a>
					</div>
				</form>
			</div>
		</div>
...
<footer class="page-footer text-center text-md-left">
	<div class="footer-copyright py-3 text-center">
      <div class="container-fluid">
        &#xA9; 2023 Copyright: ATK Kelurahan Cipayung
      </div>
    </div>
</footer>
